...
class EntityLiveData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, entity_type, last_updated, *args, **kwargs):  # noqa: E501
        """EntityLiveData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, entity_type, last_updated, *args, **kwargs):  # noqa: E501
        """EntityLiveData - a model defined in OpenAPI
