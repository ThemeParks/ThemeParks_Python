...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DestinationsApi()
        api_instance.get_destinations  # this is an instance of the class Endpoint
        api_instance.get_destinations()  # this invokes api_instance.get_destinations.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_destinations.callable or self.callable in this class
